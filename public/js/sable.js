...
function App(conf) {
  conf = {
    ...
    light1Color: 0x99503e,
    light2Color:  0x99503e,
    light3Color:  0x99503e,
    light4Color:   0x99503e,
...
/*
    ...
    var material = new THREE.MeshLambertMaterial({
      map: loader.load('../img/FenneK0001.png')
    });
    ...
    //mesh.material.color.set(0xE6E6E6);
...
*/
  ...
  function animatePlane() {
    ...
    const time = Date.now() * 0.0002;// vitessssssss
